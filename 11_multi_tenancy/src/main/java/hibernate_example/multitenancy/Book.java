...
/**
 * create table Books ( id bigint generated by default as identity (start with 1), title varchar(255), isbn varchar(255), authors
 * varchar(255), published_date date(8), primary key (id) );
 *
 * @author GHajba
 *
 */
